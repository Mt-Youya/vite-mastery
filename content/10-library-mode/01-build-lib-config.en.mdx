...
<Callout type="note" title="What you will learn">
  - The real difference between application mode and library mode - What each `build.lib` field controls - Why libraries
  externalize peer dependencies - How `package.json exports` controls consumer imports - How to verify that another
  project can actually consume the package
</Callout>

<Callout type="tip" title="Prerequisites">

- Understand ESM and CommonJS - Read [7.1 · Vite build and Rolldown](/docs/07-build-pipeline/01-rolldown-in-build)
