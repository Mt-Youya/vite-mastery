...
<Callout type="note" title="What you will learn">
  - How to classify Vite problems before changing config - Common failures in dev server, HMR, build, and dependency
  optimization - When to use `--debug`, `--force`, `vite-plugin-inspect`, and DevTools - How to trace blank pages to
  paths, cache, chunks, or browser extensions
</Callout>

<Callout type="tip" title="Prerequisites">
  - Understand [0.5 · CLI Workflow](/docs/00-getting-started/05-cli-workflow) - Understand [12.2 · Vite
