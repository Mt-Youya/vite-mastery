...
<Callout type="note" title="What you will learn">
  - Which source features Vite supports out of the box - How `import.meta.glob` turns files into module maps - Where
  Workers, WASM, JSON, and CSS Modules fit - When to use built-in features and when to write a plugin
</Callout>

<Callout type="tip" title="Prerequisites">
  - Understand [1.1 · Native ESM](/docs/01-core-concepts/01-native-esm) - Know [7.2 · Asset
