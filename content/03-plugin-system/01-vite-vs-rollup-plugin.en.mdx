...
<Callout type="note" title="What you will learn">
  - How Vite, Rollup, and Rolldown plugins relate - Which hooks are portable and which are Vite-only - Why dev server
  hooks differ from production build hooks - A practical decision flow for plugin authors
</Callout>

<Callout type="tip" title="Prerequisites">
  - Understand [1.2 · Vite 8 unified architecture](/docs/01-core-concepts/02-unified-architecture) - Read [2.4 · Plugin
  API compatibility](/docs/02-bundler-evolution/04-plugin-api-compat)
</Callout>
