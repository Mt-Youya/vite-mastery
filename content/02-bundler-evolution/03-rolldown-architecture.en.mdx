...
2. **Chunk splitting** — based on dynamic `import()` boundaries and `rollupOptions.output.manualChunks` configuration, decides how to pack modules into different chunk files
