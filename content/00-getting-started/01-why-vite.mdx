...
<Callout type="note" title="你将学到什么">
  - Webpack dev server 慢在哪里 - 浏览器原生 ESM 解决了什么问题 - 为什么 Vite 在 dev 用 esbuild、build 用 Rollup
</Callout>
...
<Callout type="tip">答案在 [Part 1 · Core Concepts](/docs/01-core-concepts) 里展开。</Callout>
