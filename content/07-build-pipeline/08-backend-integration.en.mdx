...
<Callout type="note" title="What you will learn">
  - When backend integration is needed - How to inject `@vite/client` and app entries in dev - How to read
  `.vite/manifest.json` in production - React Fast Refresh, asset URLs, and modulepreload caveats
</Callout>

<Callout type="tip" title="Prerequisites">
  - Understand [7.1 · Rolldown in Build](/docs/07-build-pipeline/01-rolldown-in-build) - Understand [7.2 · Asset
