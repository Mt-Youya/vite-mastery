...
- How `base` affects JS, CSS, images, and dynamic chunks - How to deploy to root paths, sub paths, and relative paths
  - Why double-clicking `dist/index.html` often fails - How manifests and cache policy work together

</Callout>

<Callout type="tip" title="Prerequisites">
  - Understand [7.1 · Production Build](/docs/07-build-pipeline/01-rolldown-in-build) - Understand [0.5 · CLI
